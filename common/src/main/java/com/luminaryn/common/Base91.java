...
/**
 * A class for encoding and decoding in the Base91 format.
 *
 * Created by Tim Totten on 2017-10-06.
 */
public class Base91 {
    ...
    {
        int estimatedSize = (int) Math.ceil(data.length
    ...
    {
        String out = new String(encode(data));
        return out;
    }
    ...
    public static byte[] decode (byte[] data)
    {
        try {
            ...
            int estimatedSize = Math
                    .round(data.length / AVERAGE_ENCODING_RATIO);
